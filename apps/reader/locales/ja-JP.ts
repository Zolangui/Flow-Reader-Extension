export default {
  ...
  'ai.index.success': '本のインデックスが完了しました！AIが内容に関する質問に答えられるようになりました。',
  'ai.index.failed': 'インデックスに失敗しました: {error}',
  'ai.confirm_reset': 'AIパラメータをデフォルトにリセットしますか？（APIキーとベースURLは保持されます）',
  'ai.confirm_clear': 'このセッションのすべてのチャットメッセージとメモリをクリアしますか？',
  ...
  'ai.settings.model_hint.gemini': '速度重視：gemini-1.5-flash。品質重視：gemini-1.5-pro。',
  'ai.settings.model_hint.openai': '速度重視：gpt-4o-mini。品質重視：gpt-4o。',
  'ai.settings.model_hint.anthropic': '推奨：claude-3-5-sonnet-latest。',
  'ai.settings.model_hint.local': 'OllamaやLM Studioに接続します。データは外部に出ません。',
  'ai.settings.model_hint.custom': 'OpenAI互換プロキシやエンドポイントを使用します。',
  ...
  'ai.settings.privacy_desc': 'APIキーと履歴はローカルで暗号化して保存されます。',
  ...
  'ai.settings.adaptive_context_hint': 'AIの性格と境界を定義します。自動ペルソナが有効な場合、本のメタデータに基づいて強化されます。',
  ...
  'ai.chatbot.empty_state_desc': '現在の本について何でも質問してください！アシスタントはRAGを使って関連する章と引用を探します。',
  'ai.chatbot.index_description': 'この本はまだAIで処理されていません。今すぐインデックスしてセマンティック検索と正確な引用を利用しましょう。',
  'ai.chatbot.start_indexing': 'インデックス開始',
  'ai.chatbot.indexing_knowledge': '知識を処理中...',
  'ai.chatbot.indexing_subtext': '章を抽出し、意味ベクトルを生成しています。数秒で完了します。',
  ...
  'ai.status.single_thread': 'シングルスレッドのみ（Firefox MV3 では遅くなります）',
  'ai.status.preload_timeout': '事前読み込みがタイムアウトしました（再試行してください）',
